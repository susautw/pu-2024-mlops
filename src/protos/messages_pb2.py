...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_WORKERSTATUS']._serialized_end=512
  _globals['_WORKERDATA']._serialized_start=514
  _globals['_WORKERDATA']._serialized_end=632
