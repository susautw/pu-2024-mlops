...
class WorkerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StartWorker = channel.unary_unary(
                ...
                request_serializer=worker__pb2.StartWorkerRequest.SerializeToString,
...
def add_WorkerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StartWorker': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=worker__pb2.StartWorkerRequest.FromString,
...
class Worker(object):
    ...
    def StartWorker(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/worker.Worker/StartWorker',
            worker__pb2.StartWorkerRequest.SerializeToString,
